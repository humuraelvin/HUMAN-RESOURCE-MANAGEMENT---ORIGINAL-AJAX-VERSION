  ...
  <div class="modal fade" id="employeeAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        // Edit Employee
                        document.querySelectorAll('.editEmployeeBtn').forEach(function (button) {
                button.addEventListener('click', function (e) {
                    e.preventDefault();
                    var employee_id = this.value;
                    var xhr = new XMLHttpRequest();
                    ...
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        ...
                        if (res.status == 200) {
                            ...
                            document.getElementById('idNum').value = res.data.idNum;
                            document.getElementById('phone').value = res.data.phone;
                            document.getElementById('gender').value = res.data.gender;
                            document.getElementById('employeeEditModal').classList.add('show');
                ...
                document.querySelectorAll('#employeeEditModal .btn-close').forEach(function(button) {
                button.addEventListener('click', function() {
                    document.getElementById('employeeEditModal').classList.remove('show');
                    document.getElementById('employeeEditModal').style.display = 'none';
                });
